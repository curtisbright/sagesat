...
_lr_signature = 'U\x86\xad\x1fkk\xf7l\x80\x12B\xf0&\x8bf-'
    
_lr_action_items = {'AND':([10,11,12,15,16,25,26,29,30,31,34,40,43,],[22,-23,-22,-21,-25,22,22,22,22,22,-24,-17,22,]),'OR':([10,11,12,15,16,25,26,29,30,31,34,40,43,],[23,-23,-22,-21,-25,23,23,23,23,23,-24,-17,23,]),'RPAREN':([11,12,15,16,24,25,26,29,30,31,32,33,34,35,37,39,40,43,47,48,],[-23,-22,-21,-25,-26,34,-20,-18,-19,-26,40,-13,-24,41,-12,-15,-17,-26,50,-14,]),'GRAPH':([0,2,3,4,5,8,10,11,12,15,16,17,18,20,26,29,30,34,40,41,44,46,50,52,],[6,-3,-5,6,-4,-6,-16,-23,-22,-21,-25,-1,-2,-7,-20,-18,-19,-24,-17,-26,-8,-11,-9,-10,]),'NUMBER':([1,13,14,22,23,24,27,38,42,49,],[11,11,11,11,11,11,35,11,47,11,]),'ID':([1,6,7,13,14,16,21,22,23,24,28,38,49,],[16,16,16,16,16,-25,16,16,16,16,16,16,16,]),'ASSERT':([0,2,3,4,5,8,10,11,12,15,16,17,18,20,26,29,30,34,40,41,44,46,50,52,],[1,-3,-5,1,-4,-6,-16,-23,-22,-21,-25,-1,-2,-7,-20,-18,-19,-24,-17,-26,-8,-11,-9,-10,]),'EQUALS':([41,],[45,]),'BOOL':([0,2,3,4,5,8,10,11,12,15,16,17,18,20,26,29,30,34,40,41,44,46,50,52,],[7,-3,-5,7,-4,-6,-16,-23,-22,-21,-25,-1,-2,-7,-20,-18,-19,-24,-17,-26,-8,-11,-9,-10,]),'LPAREN':([1,12,13,14,16,19,22,23,24,36,38,49,],[13,24,13,13,-25,27,13,13,13,42,13,13,]),'LBRACKET':([45,],[49,]),'NOT':([1,13,14,22,23,24,38,49,],[14,14,14,14,14,14,14,14,]),'COMMA':([11,12,15,16,26,29,30,31,34,40,43,],[-23,-22,-21,-25,-20,-18,-19,38,-24,-17,38,]),'RBRACKET':([11,12,15,16,26,29,30,31,33,34,37,39,40,43,48,49,51,],[-23,-22,-21,-25,-20,-18,-19,-26,-13,-24,-12,-15,-17,-26,-14,-26,52,]),'SAGEGRAPH':([0,2,3,4,5,8,10,11,12,15,16,17,18,20,26,29,30,34,40,41,44,46,50,52,],[9,-3,-5,9,-4,-6,-16,-23,-22,-21,-25,-1,-2,-7,-20,-18,-19,-24,-17,-26,-8,-11,-9,-10,]),'DOT':([9,],[21,]),'$end':([2,3,4,5,8,10,11,12,15,16,17,18,20,26,29,30,34,40,41,44,46,50,52,],[-3,-5,0,-4,-6,-16,-23,-22,-21,-25,-1,-2,-7,-20,-18,-19,-24,-17,-26,-8,-11,-9,-10,]),}
...
_lr_goto_items = {'graphdef':([41,],[44,]),'nonemptylist':([31,43,],[37,48,]),'expr':([1,13,14,22,23,24,38,49,],[10,25,26,29,30,31,43,31,]),'vardecl':([0,4,],[2,17,]),'boolvardecl':([0,4,],[3,3,]),'idprod':([1,6,7,13,14,21,22,23,24,28,38,49,],[12,19,20,12,12,28,12,12,12,36,12,12,]),'program':([0,],[4,]),'assertdecl':([0,4,],[5,18,]),'operation':([1,13,14,22,23,24,38,49,],[15,15,15,15,15,15,15,15,]),'graphvardecl':([0,4,],[8,8,]),'exprlist':([24,49,],[32,51,]),'empty':([24,31,41,43,49,],[33,39,46,39,33,]),}
...
_lr_productions = [
  ...
  ('graphvardecl -> SAGEGRAPH DOT idprod idprod LPAREN NUMBER RPAREN','graphvardecl',7,'p_graphvardecl','/home/ezulkosk/git/sagesat/src/front/parser.py',47),
